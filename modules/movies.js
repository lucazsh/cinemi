  ...
  movies.forEach(movie => {
    ...
    row.innerHTML = `
      ...
      <div style="display:flex; gap:6px; flex-shrink:0;">
        <button class="sm-action-btn" data-action="watchlist" style="display:flex; align-items:center; justify-content:center; padding:8px; color:#e3e3e3; border:none; border-radius:6px; cursor:pointer; background-color:var(--placeholder-bg);">${SVG_WATCHLIST}</button>
        <button class="sm-action-btn" data-action="favorites" style="display:flex; align-items:center; justify-content:center; padding:8px; color:#e3e3e3; border:none; border-radius:6px; cursor:pointer; background-color:var(--placeholder-bg);">${SVG_FAVORITES}</button>
      </div>
    `;
